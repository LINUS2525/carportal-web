...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@car-portal.t3wr5.mongodb.net/?retryWrites=true&w=majority&appName=car-portal`;
...
async function run() {
  try {
    ...
    //create db
    const db = client.db("CarManageX");
    const jobsCollections = db.collection("demoCars");
